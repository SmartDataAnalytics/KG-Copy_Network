...
class VanillaSeqToSeq(nn.Module):
    ...
    def save_model(self,dec_type):
        ...
        if USEKB:
            directory = 'save/vanilla_KB-'+name_data+str(self.task)+'HDD'+str(self.hidden_size)+'DR'+str(self.dropout)+'L'+str(self.n_layers)+'lr'+str(self.lr)+'F1'+str(self.f1)+str(dec_type)
        else:
            directory = 'save/vanilla_noKB-'+name_data+str(self.task)+'HDD'+str(self.hidden_size)+'DR'+str(self.dropout)+'L'+str(self.n_layers)+'lr'+str(self.lr)+'F1'+str(self.f1)+str(dec_type)
